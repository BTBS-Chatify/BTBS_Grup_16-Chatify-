...
export default function Login()
{
    ...
    return (
        <div className="flex min-h-full flex-col bg-white justify-center  items-center">,
            ...
            <div className="  absolute left-60 top-10 transform -translate-x-3 -translate-y-1/5 hidden lg:block  w-66 h-66 rounded-full animate-bounce duration-200"
      style={{
            overflow: 'hidden', 
          }}
        >
       ...
       >
        ...
        <div
          className="absolute right-60 bottom-10 transform -translate-x-1/2 -translate-y-1/5 hidden lg:block w-27 h-27 rounded-full animate-bounce duration-200"
        ...
        <div
          className="absolute right-40 top-10 transform -translate-x-1/2 -translate-y-1/5 hidden lg:block w-27 h-27 rounded-full animate-bounce duration-200"
        ...
        <div
          className="absolute right-20 top-96 transform -translate-x-1/2 -translate-y-1/5 hidden lg:block w-27 h-27 rounded-full animate-bounce duration-200"
