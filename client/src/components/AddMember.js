...
export default function AddMember({ user, groupId }) {
    ...
    async function onSubmit(e) {
        ...
        var data = {
            groupId: groupId,
            userId: e.target.password.value,
        };
    }
                    ...
                    <button type="button"
                        ...
                        <div className="bg-blue-500 hover:bg-blue-600 transition duration-300 h-12 w-12 rounded-full inline-flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="h-8 w-8 text-white" viewBox="0 0 16 16">
                                <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                                <path fillRule="evenodd"
                                      d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5"/>
                            </svg>
                        </div>
                        <span className="font-medium " style={{color: "#505050", marginLeft: "8px"}}>Üye ekle</span>
                    </button>
                </div>
            </Disclosure.Button>
                ...
                <form onSubmit={onSubmit} className="my-6">
                    ...
                    <Combobox value={selected} onChange={setSelected}>
                        <div className="relative mt-1">
                            <div
                                className="relative w-full cursor-default overflow-hidden rounded-lg bg-white text-left shadow focus:outline-0 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
                                <Combobox.Input
                            ...
                            >
                                <Combobox.Options
                                    className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg outline-0 sm:text-sm">
                    ...
                    <button className="bg-slate-700 text-white font-normal rounded py-2 px-4 mt-4">
                        Davet et
                    </button>
