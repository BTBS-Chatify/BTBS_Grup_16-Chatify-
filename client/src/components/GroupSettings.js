                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <p className="font-normal" style={{ color: "#505050", marginLeft:"25px", marginTop: "-20px"}}>Mesajlar ve aramalar uçtan uca şifrelidir. Daha fazla bilgi için dokunun.</p>
                                    ...
                                    <div className="w-full flex items-center py-2 my-2">
                                        <img src="/assets/1.jpg" alt=""className="h-12 w-12 rounded-full"/>
                                        <div className="flex flex-col gap-1">
