        ...
        <>
            <Menu as="div" className="relative">
                <Menu.Button className="-m-1.5 flex items-center p-1.5">
                    ...
                    <Image src={`/assets/` + picture} height={36} width={36} className="rounded-full bg-gray-50"></Image>
                    <span className="flex lg:items-center">
                      <span className="ml-1 lg:ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">
