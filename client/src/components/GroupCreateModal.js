...
const GroupCreateModal = ({ user }) => {
    ...
    async function onSubmit(e) {
        ...
        axios.post(serverUrl + endpoint, groupData)
            .then(res => {
        ...
        <>
            <div className="">
                <Tippy content="Grup Oluştur">
                    <button onClick={openModal} className="bg-blue-500 rounded-full text-white hover:bg-blue-600 h-8 w-8 flex flex-row justify-center items-center">
                        <svg
            ...
            <Transition appear show={isOpen} as={Fragment}>
                <Dialog as="div" className="relative z-50" onClose={closeModal}>
                    ...
                    <form onSubmit={onSubmit} method="post" className="fixed inset-0 overflow-y-auto">
