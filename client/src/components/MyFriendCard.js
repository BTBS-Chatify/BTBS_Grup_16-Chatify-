    ...
    <div className="bg-slate-100 my-5 p-3 rounded-lg">
      <div className="w-full flex justify-between items-center">
        <div className="flex flex-row space-x-2 items-center">
          {
            friend.user1Id === userId ? <Image src={`/assets/` + friend.user2.picture} className="rounded-full" width="48" height="48" alt=""/> : <Image src={`/assets/` + friend.user1.picture} className="rounded-full" width="48" height="48" alt=""/>
          }
          <div className="flex flex-col gap-1">
            <span className="text-sm text-slate-700 font-bold">@{
              friend.user1Id === userId ? friend.user2.username : friend.user1.username
            }</span>
          </div>
        </div>
        <div>
                ...
                friend.user1Id === userId ? (
                    ...
                    <div className="inline-flex space-x-1">
                      <Tippy content="Kabul et">
                        <button className="bg-lime-500 p-2 rounded-lg text-white text-base"
                      ...
                      <Tippy content="Reddet">
                        <button className="bg-red-500 p-2 rounded-lg text-white text-base">
                          <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-5 w-5 text-white"
                              viewBox="0 0 512 512"
